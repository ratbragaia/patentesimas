...
|---|---|---|---|
| 1 | CNPJ opened (Ltda, **Lucro Presumido**) + accountant's fiscal parameters for service export (NFS-e service code, ISS treatment, CNAE) | `docs/decisions/0002-fiscal-parameters.md` | 🟡 CNPJ 40.435.866/0001-40 (Rockfort Hub de Inovação Ltda) and CNAE 63.19-4-00 received 2026-09-26; regime Lucro Presumido; still pending from the accountant: NFS-e service code, ISS export treatment, PIS/COFINS export exemption evidence, net-vs-gross invoice to Paddle |
