# Subscription and Refund Policy — PatentSonar

**Version 1.0 · Effective 2026-09-26**

1. **Try before you pay.** Anyone may request the current issue free of charge before subscribing. We would rather you decide with the product in hand.
2. **30-day money-back guarantee, every plan.** Whether you chose a monthly or an annual plan, your first charge is refundable in full if you ask within 30 days of the order completion date. No questions asked.
3. **Monthly plans after the first 30 days.** Cancel at any time; access continues to the end of the paid month. Charges for months already delivered are not refunded.
4. **Annual plans after the first 30 days.** You may cancel and receive a pro-rata refund of the unused full months, minus one month, or convert the unused balance into additional Reader seats or a longer term. Any founding-member or annual-prepay discount is applied proportionally when calculating the refund.
