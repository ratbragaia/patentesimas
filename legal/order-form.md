...
**Included:** as described for the plan at https://patentsonar.com/#pricing on the start date.
**Terms:** This order is governed by the PatentSonar Terms of Service and Refund Policy in force on the start date (links). No other terms apply unless both parties sign an amendment.

The sales agent may not add, remove or reword any clause. Requests for changes are logged as a `finance` task and answered by the founder after counsel review.
