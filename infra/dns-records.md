...
| TXT | _dmarc | `v=DMARC1; p=none; rua=mailto:dmarc@patentsonar.com; fo=1` | DMARC. **Still to add** (2026-09-26). Start `p=none`; move to `p=quarantine` after 2 clean weeks. Reports land in the catch-all → founder |
