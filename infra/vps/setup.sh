...
for t in patentsonar-ingest patentsonar-newsletter-build patentsonar-newsletter-send patentsonar-invoices patentsonar-report patentsonar-agent patentsonar-outreach patentsonar-inbox; do systemctl enable --now $t.timer; done
