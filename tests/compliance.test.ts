...
const vars = { first_name: "Alex", personal_hook: "I noticed your team's recent iron nitride filing.", count: "7", sender_name: "RareFree Analyst",
  company_name: "RareFree Intelligence", postal_address: "Rua Exemplo 1, São Paulo, Brazil", unsubscribe_url: "https://rarefree.com/opt-out?x=1" };
...
describe("outreach compliance", () => {
  ...
  it("blocks missing opt-out link", () => expect(checkOutreach(draft({ body: "Hi Alex, because your team files magnets. RareFree Intelligence, Rua Exemplo 1, São Paulo, Brazil" }), new Set()).problems).toContain("missing opt-out link"));
